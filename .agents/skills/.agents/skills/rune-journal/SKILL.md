...
- `neural-memory` (L3): after ADR writes or notable state transitions — extract reusable patterns across projects
...
- `logic-guardian` (L2): record business-logic manifest decisions and protected-logic changes
