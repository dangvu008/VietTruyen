...
| Letting a human or fix skill patch an agent-created bug without autopsy | CRITICAL | Agent Bug Autopsy Gate: debug first, record symptom/cause/reproduction/prevention, then fix |
