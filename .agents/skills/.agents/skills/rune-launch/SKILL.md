...
- `docs` (L2): ensure launch-facing docs, changelog, and usage guidance are current
...
- `verification` (L3): run final lint, type, test, and build checks before deploy handoff
- `git` (L3): create release commit/tag metadata and release notes inputs
