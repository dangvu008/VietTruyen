...
- `mcp-builder` (L2): delegate MCP server implementation when the scaffold target is a tool/resource server
...
- `context-pack` (L3): package structured handoff packets before parallel or delegated generation
