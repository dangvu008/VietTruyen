---
name: rune-improve-architecture
...
3. The target module's source files (Find files by pattern to enumerate, cap at 30 files)
...
```yaml
chain_metadata:
  skill: "the rune-improve-architecture skill"
  version: "0.1.0"
  status: "[DONE]"
  ...
  suggested_next:
    - skill: "the rune-brainstorm skill"
