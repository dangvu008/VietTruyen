...
const edges: NarrativeEdge[] = [
  {
    id: 'edge-1',
    projectId: 'P001',
    fromNodeId: 'P001:character:luc-tram',
    toNodeId: 'arc-1',
    edgeType: 'dependency',
    weight: 1,
    evidenceChapterIds: ['ch-3'],
    updatedAt: '2026-08-15T00:00:00Z',
  },
  {
    id: 'edge-2',
    ...
    fromNodeId: 'arc-1',
    toNodeId: 'hook-1',
    edgeType: 'foreshadow_link',
    weight: 0.9,
    evidenceChapterIds: ['ch-9'],
    updatedAt: '2026-08-15T00:00:00Z',
  },
  {
    id: 'edge-noise',
