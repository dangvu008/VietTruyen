            ...
            {authMode === 'choices' ? (
              <>
                ...
                <div className="flex items-center gap-4 py-2 mt-4">
                  <div className="flex-1 h-px" style={{ background: 'rgba(80,69,59,0.3)' }} />
                  <span className="text-xs uppercase tracking-wider" style={{ color: '#50453b' }}>hoặc</span>
                  <div className="flex-1 h-px" style={{ background: 'rgba(80,69,59,0.3)' }} />
                </div>
                ...
                <button
                  ...
                  disabled={isLoading}
                  className="w-full flex items-center justify-center gap-2 px-6 py-4 rounded-xl font-medium transition-all duration-300 disabled:opacity-50 group"
                  style={{ background: 'transparent', color: '#9c8e82' }}
                  onMouseEnter={(e) => (e.currentTarget.style.color = '#f2c08d')}
                  onMouseLeave={(e) => (e.currentTarget.style.color = '#9c8e82')}
                >
                  <ArrowRight size={18} className="group-hover:translate-x-1 transition-transform" />
                  <span>Khám phá với chế độ khách</span>
                </button>
              </>
            ) : (
